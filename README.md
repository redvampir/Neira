...
-->
<!-- neira:meta
id: NEI-20240909-120100-lymphatic-link
intent: docs
...
- Написан на Rust и может запускаться как отдельный сервис или библиотеки.
...
2. Запустите `run.bat` для старта Нейры
3. Интерфейс откроется автоматически в браузере
4. Логи сохраняются в папке `logs`

## Решение проблем

Если возникают ошибки:
1. Убедитесь что установлен Rust (rustup.rs)
