...
## Системные ActionNodes

### BasePathResolverNode

Определяет базовый путь проекта. Узел поднимается от текущего исполняемого файла вверх по иерархии каталогов,
...
узел читает базовый путь из памяти (см. `BasePathResolverNode`) и устанавливает её автоматически.
