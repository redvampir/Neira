...
- [4. Связь с клеткими анализа](#4-связь-с-клеткими-анализа)
...
## 4. Связь с клеткими анализа
Политика источников используется при [фильтрации и весовке источников](analysis-cells.md#4-фильтрация-и-весовка-источников). Общие сведения об архитектуре клеток приведены в файле [analysis-cells.md](analysis-cells.md).
