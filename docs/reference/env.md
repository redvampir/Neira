...
<!-- neira:meta
id: NEI-20250930-env-list-doc
intent: docs
summary: Добавлен пример команды env:list для просмотра текущих переменных.
-->

# ENV Reference (Истина)

Просмотреть активные значения можно командой:
...
| NEIRA_BIND_ADDR                | string | 127.0.0.1:3000     | http        | Адрес/порт HTTP‑сервера (для тестов можно указывать уникальный порт, например `0.0.0.0:4000`) |
